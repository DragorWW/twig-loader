...
module.exports = function(id, tokens, pathToTwig) {
    ...
    var output = [
        ...
        '    template = twig({id:' + JSON.stringify(id) + ', data:' + JSON.stringify(parsedTokens) + ', allowInlineIncludes: true, rethrow: true, autoescape: true,});\n',
        'module.exports = function(context) { return template.render(context).toString(); }'
    ];
